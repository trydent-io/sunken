...
public class StatusCodes {
  ...
  private static final io.undertow.util.StatusCodes.Entry[] TABLE = new io.undertow.util.StatusCodes.Entry[SIZE];
  ...
  private static void putCode(int code, String reason) {
    io.undertow.util.StatusCodes.Entry e = new io.undertow.util.StatusCodes.Entry(reason, code);
    int h = code & SIZE;
    if(TABLE[h] != null) {
  ...
  public static final String getReason(final int code) {
    final io.undertow.util.StatusCodes.Entry result = TABLE[code & SIZE];
